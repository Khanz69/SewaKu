...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  },
  {
    ...
    resource: "/produk_alat_konstruksi",
...
export const findCategoryByResource = (resource?: string) =>
  PRODUCT_CATEGORIES.find((category) => category.resource === resource) || DEFAULT_CATEGORY;