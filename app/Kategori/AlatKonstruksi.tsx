...
const CATEGORY_KEY: ProductCategoryKey = "alat_konstruksi";
const CATEGORY_CAR_TYPES = ["Excavator", "Loader", "Compactor", "Mixer", "Generator"];
...
export default function AlatKonstruksi() {
  ...
  const {
    ...
    emptyMessage: "Alat konstruksi tidak tersedia di saat ini.",
  });
