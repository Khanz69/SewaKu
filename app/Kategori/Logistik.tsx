...
const CATEGORY_KEY: ProductCategoryKey = "logistik";
const CATEGORY_CAR_TYPES = ["Pickup", "Truk", "Box", "Double Cabin", "Tangki"];
...
export default function Logistik() {
  ...
  const {
    ...
    emptyMessage: "Logistik tidak tersedia di saat ini.",
  });
