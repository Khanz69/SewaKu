...
const CATEGORY_KEY: ProductCategoryKey = "bus";
const CATEGORY_CAR_TYPES = ["Pariwisata", "Mewah", "Medium", "Mini", "VIP"];
...
export default function Bus() {
  ...
  const {
    ...
    emptyMessage: "Bus tidak tersedia di saat ini.",
  });
